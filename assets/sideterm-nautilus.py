...
class OpenInSideTermAction(GObject.GObject, Nautilus.MenuProvider):
    def __init__(self):
        super().__init__()
    ...
    def _make_item(self, name, paths):
        item = Nautilus.MenuItem(name=name, label='Open in SideTerm',
            icon='org.sideterm.sideterm')
    ...
    def get_file_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='SideTermNautilus::open_in_sideterm', paths=paths)]
        else:
            return []
    ...
    def get_background_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='SideTermNautilus::open_folder_in_sideterm', paths=paths)]
        else:
            return []
